...
exports.SERVICE_INSTALLER_METHOD_CODE_BLOCK = exports.updateDockerComposeDevProperties = exports.DOCKER_SERVICE_KAFKA_UI_NAME = exports.DOCKER_SERVICE_KAFKA_PORT = exports.DOCKER_SERVICE_ZOOKEEPER_PORT = exports.DOCKER_SERVICE_ZOOKEEPER_NAME = exports.DOCKER_SERVICE_KAFKA_NAME = void 0;
exports.DOCKER_SERVICE_KAFKA_NAME = "kafka";
exports.DOCKER_SERVICE_ZOOKEEPER_NAME = "zookeeper";
exports.DOCKER_SERVICE_ZOOKEEPER_PORT = "2181";
exports.DOCKER_SERVICE_KAFKA_PORT = "9092";
exports.DOCKER_SERVICE_KAFKA_UI_NAME = "kafka-ui";
exports.updateDockerComposeDevProperties = {
    services: {
        [exports.DOCKER_SERVICE_ZOOKEEPER_NAME]: {
            ...
            ports: [
                `${exports.DOCKER_SERVICE_ZOOKEEPER_PORT}:${exports.DOCKER_SERVICE_ZOOKEEPER_PORT}`,
            ],
        },
        [exports.DOCKER_SERVICE_KAFKA_NAME]: {
            image: "confluentinc/cp-kafka:7.3.1",
            depends_on: [exports.DOCKER_SERVICE_ZOOKEEPER_NAME],
            ports: ["9092:9092", "9997:9997"],
            environment: {
                KAFKA_BROKER_ID: 1,
                KAFKA_ZOOKEEPER_CONNECT: `${exports.DOCKER_SERVICE_ZOOKEEPER_NAME}:${exports.DOCKER_SERVICE_ZOOKEEPER_PORT}`,
                KAFKA_ADVERTISED_LISTENERS: `PLAINTEXT://${exports.DOCKER_SERVICE_KAFKA_NAME}:29092,PLAINTEXT_HOST://localhost:${exports.DOCKER_SERVICE_KAFKA_PORT}`,
        ...
        [exports.DOCKER_SERVICE_KAFKA_UI_NAME]: {
            container_name: exports.DOCKER_SERVICE_KAFKA_UI_NAME,
            image: "provectuslabs/kafka-ui:latest",
            ports: ["8080:8080"],
            depends_on: [exports.DOCKER_SERVICE_ZOOKEEPER_NAME, exports.DOCKER_SERVICE_KAFKA_NAME],
            environment: {
...
exports.SERVICE_INSTALLER_METHOD_CODE_BLOCK = `
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createConsumerServiceFile = void 0;
const csharp_ast_1 = __webpack_require__(701);
function createConsumerServiceFile(resourceName, messageBrokerName, brokerBasePath) {
    const messageControllerClassName = `${messageBrokerName}MessageHandlersController`;
    const consumerService = csharp_ast_1.CsharpSupport.class_({
        ...
        partial: false,
        access: "public",
        parentClassReference: csharp_ast_1.CsharpSupport.genericClassReference({
...
exports.createConsumerServiceFile = createConsumerServiceFile;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createMessageBrokerControllerFile = void 0;
const code_gen_types_1 = __webpack_require__(288);
const csharp_ast_1 = __webpack_require__(701);
const pascal_case_1 = __webpack_require__(262);
function createMessageBrokerControllerFile(resourceName, messageBrokerName, brokerBasePath, dsgContext) {
    const { logger, serviceTopics } = dsgContext;
    const messageControllerClassName = `${messageBrokerName}MessageHandlersController`;
    const messageHandlerController = csharp_ast_1.CsharpSupport.class_({
        name: messageControllerClassName,
        namespace: `${resourceName}.Brokers.${messageBrokerName}`,
        abstract: false,
        sealed: false,
    ...
    logger.info(`generating topic handler methods for ${messageBrokerName} message controller`);
    if (!serviceTopics) {
    ...
    serviceTopics.map((serviceTopic) => {
        ...
        serviceTopic.patterns.forEach((topic) => {
            logger.info(`Creating message handler method for topic ${topic.topicName}`);
            if (!topic.topicName) {
                throw new Error(`Topic name not found for topic id ${topic.topicId}`);
            }
            if (topic.type !== code_gen_types_1.EnumMessagePatternConnectionOptions.Receive)
                return;
...
exports.createMessageBrokerControllerFile = createMessageBrokerControllerFile;
function createMethod(resourceName, topicName) {
    return csharp_ast_1.CsharpSupport.method({
        name: `Handle${(0, pascal_case_1.pascalCase)(topicName)}`,
        access: "public",
        type: csharp_ast_1.MethodType.INSTANCE,
        isAsync: false,
        return_: csharp_ast_1.CsharpSupport.Types.reference(csharp_ast_1.CsharpSupport.classReference({
            name: "Task",
            namespace: `System.Threading.Tasks`,
        })),
        annotations: [
            csharp_ast_1.CsharpSupport.annotation({
                reference: csharp_ast_1.CsharpSupport.classReference({
                    name: "Topic",
                    namespace: `${resourceName}.Brokers.Infrastructure`,
                }),
        ...
        body: csharp_ast_1.CsharpSupport.codeblock({
      ...
      return Task.CompletedTask;`,
        ...
        parameters: [
            csharp_ast_1.CsharpSupport.parameter({
                name: "message",
                type: csharp_ast_1.CsharpSupport.Types.string(),
            }),
        ],
    });
}
...
const code_gen_types_1 = __webpack_require__(288);
const pascal_case_1 = __webpack_require__(262);
const get_message_broker_name_1 = __webpack_require__(114);
const create_consumer_service_file_1 = __webpack_require__(666);
const create_producer_service_file_1 = __webpack_require__(576);
const create_message_broker_controller_file_1 = __webpack_require__(982);
const create_service_installer_file_1 = __webpack_require__(910);
async function createMessageBroker(dsgContext) {
    const { serverDirectories, logger, resourceInfo } = dsgContext;
    const files = new code_gen_types_1.FileMap(dsgContext.logger);
    if (!resourceInfo)
        return files;
    const resourceName = (0, pascal_case_1.pascalCase)(resourceInfo.name);
    const messageBrokerName = (0, get_message_broker_name_1.getMessageBrokerName)(dsgContext);
    const brokerBasePath = `${serverDirectories.baseDirectory}/src/Brokers/${messageBrokerName}`;
    logger.info(`Creating message broker service for ${messageBrokerName}. using path ${brokerBasePath}`);
    //create consumerService file
    const consumerServiceFile = (0, create_consumer_service_file_1.createConsumerServiceFile)(resourceName, messageBrokerName, brokerBasePath);
    await files.set(consumerServiceFile);
    //create producerService file
    const producerServiceFile = (0, create_producer_service_file_1.createProducerServiceFile)(resourceName, messageBrokerName, brokerBasePath);
    await files.set(producerServiceFile);
    //create messageHandlerController file
    const messageHandlerControllerFile = (0, create_message_broker_controller_file_1.createMessageBrokerControllerFile)(resourceName, messageBrokerName, brokerBasePath, dsgContext);
    await files.set(messageHandlerControllerFile);
    const serviceInstallerFile = (0, create_service_installer_file_1.createServiceInstallerFile)(resourceName, messageBrokerName, brokerBasePath);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createProducerServiceFile = void 0;
const csharp_ast_1 = __webpack_require__(701);
function createProducerServiceFile(resourceName, messageBrokerName, brokerBasePath) {
    const producerService = csharp_ast_1.CsharpSupport.class_({
        ...
        partial: false,
        access: "public",
        parentClassReference: csharp_ast_1.CsharpSupport.classReference({
...
exports.createProducerServiceFile = createProducerServiceFile;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createServiceInstallerFile = void 0;
const csharp_ast_1 = __webpack_require__(701);
const constants_1 = __webpack_require__(921);
function createServiceInstallerFile(resourceName, messageBrokerName, brokerBasePath) {
    const serviceInstallerClass = csharp_ast_1.CsharpSupport.class_({
    ...
    serviceInstallerClass.addMethod(csharp_ast_1.CsharpSupport.method({
        ...
        classReference: csharp_ast_1.CsharpSupport.classReference({
            name: "KafkaOptions",
            namespace: `${resourceName}.Brokers.Infrastructure`,
        }),
        body: csharp_ast_1.CsharpSupport.codeblock({
        ...
        parameters: [],
        extensionParameter: csharp_ast_1.CsharpSupport.parameter({
            name: "app",
            type: csharp_ast_1.CsharpSupport.Types.reference(csharp_ast_1.CsharpSupport.classReference({
...
exports.createServiceInstallerFile = createServiceInstallerFile;
function getMethodBlock(messageBrokerName) {
    const codeBlock = constants_1.SERVICE_INSTALLER_METHOD_CODE_BLOCK;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMessageBrokerName = void 0;
const code_gen_types_1 = __webpack_require__(288);
const pascal_case_1 = __webpack_require__(262);
function getMessageBrokerName(dsgContext) {
    const { otherResources, logger } = dsgContext;
    let messageBrokerName = otherResources?.find((resource) => resource.resourceType === code_gen_types_1.EnumResourceType.MessageBroker)?.resourceInfo?.name ?? null;
    if (!messageBrokerName) {
        logger.warn("Message broker name not found. Did you forget to add a message broker resource?");
        messageBrokerName = "kafka";
    }
    return (0, pascal_case_1.pascalCase)(messageBrokerName.replaceAll(" ", ""));
}
exports.getMessageBrokerName = getMessageBrokerName;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createServiceInstallerFile = exports.createMessageBrokerControllerFile = exports.createProducerServiceFile = exports.createConsumerServiceFile = exports.getMessageBrokerName = exports.createMessageBroker = exports.createStaticFileFileMap = void 0;
...
var create_message_broker_method_1 = __webpack_require__(994);
Object.defineProperty(exports, "createMessageBroker", ({ enumerable: true, get: function () { return create_message_broker_method_1.createMessageBroker; } }));
var get_message_broker_name_1 = __webpack_require__(114);
Object.defineProperty(exports, "getMessageBrokerName", ({ enumerable: true, get: function () { return get_message_broker_name_1.getMessageBrokerName; } }));
var create_consumer_service_file_1 = __webpack_require__(666);
Object.defineProperty(exports, "createConsumerServiceFile", ({ enumerable: true, get: function () { return create_consumer_service_file_1.createConsumerServiceFile; } }));
var create_producer_service_file_1 = __webpack_require__(576);
Object.defineProperty(exports, "createProducerServiceFile", ({ enumerable: true, get: function () { return create_producer_service_file_1.createProducerServiceFile; } }));
var create_message_broker_controller_file_1 = __webpack_require__(982);
Object.defineProperty(exports, "createMessageBrokerControllerFile", ({ enumerable: true, get: function () { return create_message_broker_controller_file_1.createMessageBrokerControllerFile; } }));
var create_service_installer_file_1 = __webpack_require__(910);
Object.defineProperty(exports, "createServiceInstallerFile", ({ enumerable: true, get: function () { return create_service_installer_file_1.createServiceInstallerFile; } }));
...
class DotnetKafkaPlugin {
    ...
    beforeCreateServerAppsettings(context, eventParams) {
        ...
        const serviceName = (0, lodash_1.camelCase)(resourceInfo?.name ?? "");
    ...
    afterCreateProgramFile(context, eventParams, programClassMap) {
        const { resourceInfo } = context;
        const serviceNamespace = (0, pascal_case_1.pascalCase)(resourceInfo?.name ?? "");
        const messageBrokerName = (0, core_1.getMessageBrokerName)(context);
        const programCsPath = (0, path_1.join)(context.serverDirectories.srcDirectory, "Program.cs");
        const programClass = programClassMap.get(programCsPath);
        if (!programClass)
            return programClassMap;
        programClass.code.builderServicesBlocks.push(new csharp_ast_1.CodeBlock({
    ...
    async afterLoadStaticFiles(context, eventParams, files) {
        ...
        for (let index = 0; index < staticFiles.length; index++) {
            ...
            const filePath = (0, path_1.resolve)(__dirname, fileRelativePath.src);
            const fileMap = await (0, core_1.createStaticFileFileMap)(fileRelativePath.des, filePath, context, [
                csharp_ast_1.CsharpSupport.classReference({
    ...
    async afterCreateMessageBrokerService(dsgContext, eventParams, files) {
        const messageBrokerFiles = await (0, core_1.createMessageBroker)(dsgContext);
        await files.merge(messageBrokerFiles);
        return files;
    }
    beforeCreateDockerComposeFile(dsgContext, eventParams) {
        const updateDockerComposeProperties = {
            services: {
                server: {
                    environment: {
                        KAFKA_BROKERS: `${constants_1.DOCKER_SERVICE_KAFKA_NAME}:${constants_1.DOCKER_SERVICE_KAFKA_PORT}`,
        ...
        eventParams.updateProperties.push(constants_1.updateDockerComposeDevProperties);
        eventParams.updateProperties.push({
            services: {
                [constants_1.DOCKER_SERVICE_KAFKA_NAME]: {
                    environment: {
                        KAFKA_ADVERTISED_LISTENERS: `PLAINTEXT://${constants_1.DOCKER_SERVICE_KAFKA_NAME}:29092,PLAINTEXT_HOST://localhost:${constants_1.DOCKER_SERVICE_KAFKA_PORT}`,
                    },
                },
            },
        });
...
exports["default"] = DotnetKafkaPlugin;
