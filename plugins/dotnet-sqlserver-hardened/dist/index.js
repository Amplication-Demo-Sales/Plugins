...
module.exports = /*#__PURE__*/JSON.parse('{"settings":{"host":"localhost","port":1433,"user":"sa","password":"SqlAdminChangeMe1234!","dbName":"my-service-db"}}');
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"dotnet-sqlserver-hardened","version":"0.1.0","description":"Use an MS SQL Server database in a service generated by Amplication","main":"dist/index.js","nx":{},"scripts":{"dev":"webpack --watch","build":"webpack","prebuild":"rimraf dist"},"author":"Daniele Iasella","license":"Apache-2.0","devDependencies":{"@amplication/csharp-ast":"^0.0.4","@amplication/code-gen-types":"2.0.37","@amplication/code-gen-utils":"^0.0.9","@babel/parser":"^7.18.11","@babel/types":"^7.18.10","@types/lodash":"^4.14.182","@types/normalize-path":"^3.0.0","@typescript-eslint/eslint-plugin":"^5.33.0","@typescript-eslint/parser":"^5.33.0","copy-webpack-plugin":"^12.0.2","eslint":"^8.21.0","jest-mock-extended":"^2.0.7","lodash":"^4.17.21","pascal-case":"^3.1.2","prettier":"^2.6.2","rimraf":"^4.4.1","ts-loader":"^9.4.2","typescript":"^4.9.3","webpack":"^5.75.0","webpack-cli":"^5.0.1"}}');
...
class MSSQLServerPlugin {
    ...
    afterCreateProgramFile({ resourceInfo, serverDirectories }, eventParams, programClass) {
        ...
        if (!programCs)
            return programClass;
        programCs.code.builderServicesBlocks.push(new csharp_ast_1.CodeBlock({
...
exports["default"] = MSSQLServerPlugin;
