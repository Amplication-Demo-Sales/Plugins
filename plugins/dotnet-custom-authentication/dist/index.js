...
const src_1 = __webpack_require__(701);
const get_entity_roles_map_1 = __webpack_require__(991);
function createMethodAuthorizeAnnotation(method, roles) {
    roles &&
        method.annotations?.push(src_1.CsharpSupport.annotation({
            reference: src_1.CsharpSupport.classReference({
                name: "Authorize",
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"dotnet-custom-authentication","version":"0.1.2","description":"Add Authentication and Authorization to your .NET Services","main":"dist/index.js","nx":{},"scripts":{"dev":"webpack --watch","build":"webpack","prebuild":"rimraf dist"},"author":"Mor Hagbi","license":"Apache-2.0","devDependencies":{"@amplication/csharp-ast":"^0.0.4","@amplication/code-gen-types":"2.0.37","@amplication/code-gen-utils":"^0.0.9","@babel/parser":"^7.18.11","@babel/types":"^7.18.10","@types/lodash":"^4.14.182","@types/normalize-path":"^3.0.0","@typescript-eslint/eslint-plugin":"^5.33.0","@typescript-eslint/parser":"^5.33.0","copy-webpack-plugin":"^12.0.2","eslint":"^8.21.0","jest-mock-extended":"^2.0.7","lodash":"^4.17.21","pascal-case":"^3.1.2","prettier":"^2.6.2","rimraf":"^4.4.1","ts-loader":"^9.4.2","typescript":"^4.9.3","webpack":"^5.75.0","webpack-cli":"^5.0.1","@types/pluralize":"^0.0.29"}}');
